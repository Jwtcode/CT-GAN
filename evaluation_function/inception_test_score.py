...
from test import Sample_evaluate
...
args = cfg.parse_args()
##################################################################
# This Model adapted from https://github.com/mseitzer/pytorch-fid #
...
if __name__ == '__main__':
    ...
    #data_dir='D:/FileRecv/celeba/images4'
    #data_dir='F:/datasets/flowers/train/images'
    data_dir='D:/FileRecv/birds/img10'
    dataset =Sample_evaluate(args, data_dir,cur_img_size=128,transform=transform)
